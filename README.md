...
## QuestCraft is now in LTS!
### LTS means Long Term Support. It means QuestCraft will be less updated unless it is for a bug fix. We are ensuring that the game is bug-free and performance is improved as much as possible before this happens. 
*(For more information, please read the **[Discord announcement.](https://discord.com/channels/820767484042018829/820788932123688960/1138300818064416801)**)*

         
# QuestCraft
![QC](/QCSimple3.jpg)

QuestCraft, utilizing Vivecraft and Pojlib, is a standalone port of Minecraft: Java Edition to Oculus Quest Headsets. With a team of four main developers and 8 third-party developers, over the past year, we have not only gotten Minecraft: Java Edition to run on Android, but we have also worked with third-party developers to bring it into Virtual Reality on the Meta Quest line of standalone HMDs.
...
- ### **Full Multiplayer!**                                                                    
- ### **Immersive Controls!**                                                                                                   
- ### **Supports 1.18.2, 1.19.2/4, and 1.20.1!**                                                                                                                              
- ### **Includes a launcher that allows you to start QuestCraft, as well as switch between versions, update installed mods and other MC components in milliseconds, and, using Mod Manager, download and install supported mods right from your Quest!\****
...
**NOTE: To install QuestCraft, you must have an internet connection for the initial setup to succeed, and make sure your Quest 2/3 is on v51 and above. Furthermore, you MUST own a legal, valid copy of Minecraft: Java Edition to play!**

To begin, visit the release page of **[QuestCraft](https://github.com/QuestCraftPlusPlus/QuestCraft/releases/latest)** and download the APK onto your computer or Android device.
...
Join the QuestCraft Discord Server at **discord.gg/QuestCraft** and go to #bot-commands. Type /logs and upload your log file (which can be retrieved from Android/data/com.qcxr.qcxr using a file viewer (e.g. **Windows Explorer** or **[Android File Transfer for macOS](https://www.android.com/filetransfer/)**). The QuestCraft Bot, CraftyVR, will give you ways you can fix the crash. If not, you can just scroll to the bottom of the retrieved log and check the Fabric error message for possible solutions. 
...
- **[Mod Menu](https://modrinth.com/mod/modmenu)** (Menu that lists installed mods.)
...
- **[Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin)** (Allows mods to use Kotlin in their code)
...
- **[Cull Less Leaves](https://modrinth.com/mod/cull-less-leaves/version/1.2.0)** (Culls leaves (who would've guessed???))
...
- **[Ferrite Core](https://modrinth.com/mod/ferrite-core)** (Decreases memory usage.)
...
- **[ServerCore](https://modrinth.com/mod/servercore)** (Reduces lag spikes in both single-player and servers.) 
...
**Some mods listed above are available only in specific MC versions.**
...
2. The game's render distance is best at 4-6, but you *may* encounter lag spikes when using it. Nine and above is not recommended.
...
- QuestCraft (QCXR) is developed and maintained by the QCXR team; we also contribute upstream to the open-source tools that we used to make this a reality; make sure to check out **[VivecraftMod](https://github.com/ferriarnus/VivecraftMod)** (we previously used **[MCXR](https://github.com/mcxr-org/MCXR)** for QuestCraft) and **[PojavLauncher](https://github.com/PojavLauncherTeam/PojavLauncher)**!
- The forks we use are: **[Pojlib](https://github.com/QuestCraftplusplus/pojlib)** and **[VivecraftMod](https://github.com/QuestCraftplusplus/vivecraftmod)** 
...
- Pico support is planned and is currently being developed. Until then, kindly use **[Vivecraft PCVR](https://www.vivecraft.org/)**. 
...
<a href="https://github.com/QuestCraftPlusPlus/QuestCraft/graphs/contributors">
